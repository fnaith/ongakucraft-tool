...
public final class FishBoneOneSide3Builder extends CircuitBuilder {
    public static final int BEATS_PER_SECTION = 3;

    public static FishBoneOneSide3Builder of(BlockDataset blockDataset, boolean turnRight, String floorPath, String stubPath) {
        return new FishBoneOneSide3Builder(blockDataset, turnRight, floorPath, stubPath);
    }
    ...
    private FishBoneOneSide3Builder(BlockDataset blockDataset, boolean turnRight,
